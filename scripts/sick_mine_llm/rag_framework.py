...
# from langchain_community.document_loaders import PyPDFDirectoryLoader, TextDirectoryLoader
...
def upload_data():
    ...
    loader = DirectoryLoader(
        "/home/sujee/sick_gui/scripts/sick_mine_llm/local_database/", glob="*.txt", loader_cls=TextLoader
    )
